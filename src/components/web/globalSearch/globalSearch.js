...
import { AppBar, Card, CardHeader, IconButton, TextField, RaisedButton, Snackbar, ListItem, List } from 'material-ui';
import Infinite from 'react-infinite';
import { Gravatar, ClientListItem, JobListItem, ContactListItem } from '../../../components/web';
          ...
          searchResults && searchResults.get('results') &&searchResults.get('results').length > 0 ?
            <div>
              <div style={style.heading.container}>
                ...
                {searchResults.get('results').map((item, key) => {
